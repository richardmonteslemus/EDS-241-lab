...
*Response:* 
Between the MPA and non-MPA site we see huge differences in distance to mangrove sites. Also big differences in low pollution risk between them. 
...
*Response:* 
The imbalance in low pollution risks between the MPA and non-MPA might confound the fish biomass since MPAs might have a greater biomass simply because pollution is less severe in it when compared to non-MPA sites. 
...
### ✅ Population and inference become different populations. We analyze MPAs of this kind rather than broader ones. 

**Q4.** What does `ATT` mean in the context of this MPA evaluation setting?

*Response:* Measures impact of a treatment specifcally on those who received it by comparing their outcomes to matched control groups. 
...
*Response:*  108 treated units were matched and 37 control sites were included in the matched data. 

**Q6.** Find the covariate with the largest standardized mean difference (SMD) *after matching*. Which covariate is it?

*Response:* The co-variate with the largest standardized mean difference after matching is distance to deep water. 
...
*Response:* 
On average MPA sites have a fish biomass of 172 more than non-MPA sites. 

**Q8.** What is the biggest remaining threat to causal interpretation of regression coefficients after matching?

*Response:* 
We have confounding variables that are unaccounted for.  
...
*Response:* 
It increased by a factor or two. Therefore our plot was potentially adding bias to our vapor deficit variables. 
...
Year should be included because certain years it would significantly change vapor deficit, for example when el nino occurs.
...
*Response:* _________________________
Density might be necessary to include.
